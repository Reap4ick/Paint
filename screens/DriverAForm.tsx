...
import { DriverAFormScreenProps } from './types';

const DriverAForm = ({ navigation }: DriverAFormScreenProps) => {
  ...
  const handleNext = () => {
    if (validateForm()) {
      navigation.navigate('DriverBForm', { driverA: formData });
    }
  };

  return (
    <View style={styles.container}>
      <Text style={styles.header}>Дані водія А</Text>
